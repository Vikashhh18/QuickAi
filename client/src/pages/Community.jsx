...
const Community = () => {
  ...
  return !loading? (
    <div className='flex-1 h-full w-full flex-col gap-4 p-6'>
      Creations
      <div className='bg-white h-full w-full rounded-xl overflow-y-scroll'>
        {creations.map((creation,index)=>(
          <div key={index} className='relative group inline-block pl-3 pt-3 q-full
          sm:max-w-1/2 lg:max-w-1/3'>
            ...
            from-transparent to-black/80 text-white rounded-lg cursor-pointer'>
              <p className='text-sm hidden group-hover:block'>{creation.prompt}</p>
              <div className='flexgap-1 items-center'>
